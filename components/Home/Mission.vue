<template>
  <div class="">
    <div class="bg-gray-100 py-24 w-full">
      <div class="lg:px-40 p-4 lg:py-4 grid md:grid-cols-2 gap-8">
  ...
  <!-- <div class="py-12 bg-gradient-to-r from-blue-400 via-purple-400 to-blue-950 w-full">
    <div class="">
      <h1 class="lg:px-40 p-4 lg:py-4 text-xl font-semibold text-white">
        The need for security is universal. That's why KUO engineers are pioneering 
        new research and pursuing new technologies to reduce risk of transportation of products. 
        We're committed to responsibly meeting the world's security needs.
      </h1>
    </div>
  </div> -->
</template>