<template>
  <div>
    <div class="bg-gradient-to-r from-red-950 to-red-400 w-full">
      <div class="">
        <h1 class="lg:px-40 p-4 lg:py-4 text-xl md:text-4xl font-bold text-white">Discover Us</h1>
      </div>
    </div>
  ...
  <div class="bg-gradient-to-r from-red-950 to-red-400 mt-24">
    <p class="flex text-white md:text-3xl lg:text-6xl font-black py-24 px-6 md:px-40 discover">
      <Icon class="shrink-0 md:text-4xl lg:text-8xl mt-[-0.3em]" name="ri:double-quotes-l" />
      <span>We love new challenges and we're here to take on your challenge too.</span>
    </p>
  </div>
</template>